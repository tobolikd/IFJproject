...
\begin{document}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\textwidth]{src/LL-tabulka.png}
        \caption{LL tabulka.}
        \label{LL tabulka}
    \end{figure}
